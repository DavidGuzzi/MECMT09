...
df_all.to_csv('resultados_simulación_paralelo.csv', index=False)

print("\n" + "="*80)
print(f"SIMULACIONES COMPLETADAS - FIN: {get_timestamp()}")
print(f"Resultados guardados en 'resultados_simulación_paralelo.csv'")
...
try:
    ...
    output_file = "resultados_simulación_paralelo.csv"
